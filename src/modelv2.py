...
class BilinearModel(nn.Module):
    ...
    def __init__(self, num_classes: int = 10) -> None:
        ...
        self.classifier: nn.Module = nn.Linear(128 ** 2, num_classes)
    ...
    def forward(self, inputs: torch.Tensor) -> torch.Tensor:
        ...
        outputs = outputs.view(-1, 512, 4 ** 2)  # reshape to batchsize * 512 * 28 ** 2
        ...
        outputs = outputs.view(-1, 128 ** 2)  # reshape to batchsize * 512 * 512
